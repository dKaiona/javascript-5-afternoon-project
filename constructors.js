...
////////// PROBLEM 4 ////////// 	
 ...
 // Here we have a constructor function named Movie that takes in 3 parameters: name (a string), genre (a string), 
 //and rating (a number withing 1-100 that has been averaged out from previous given ratings). Write a prototype method for the Movie 
 //constructor function called changeRating. This method should take in a number as a parameter that will be a new rating. 
 //Find the average between the old rating and the new rating. Change the rating property to become this new number and return the 
 //updated rating. 	
...
////////// PROBLEM 5 //////////	
 ...
 // Write a constructor function called User. This function should take in 4 parameters called name, age, email, and savedPosts in 
 //that order. Name and email will be strings, age will be a number and savedPosts will be an array of objects. These objects will 
 //each have 3 properties: id (a number), title (a string), and rating (a number between 1 and 5). These objects are the posts that 
